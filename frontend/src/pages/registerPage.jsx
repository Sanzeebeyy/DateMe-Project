                ...
                <div className=" relative">
                    ...
                    <div className="w-110 h-175 border-8 border-(--primary-color) mx-auto my-30 rounded-4xl bg-(--bg-color) register-card">
                        ...
                        <form action="" method="post" className="flex flex-col w-max items-center mx-auto mt-7">
                            <input type="text" placeholder="Username" className="border-2 rounded-xl text-(--secondary-color) pt-3 pb-3 px-10 " />
                            <input type="password" placeholder="Password" className="border-2 rounded-xl text-(--secondary-color) pt-3 pb-3 px-10 mt-5" />
